...
const TickMark = () => (
  <svg className="tick-mark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52">
    <circle cx="26" cy="26" r="25" fill="none" stroke="black" strokeWidth="2" />
    <path fill="none" stroke="black" strokeWidth="2" d="M14.1 27.2l7.1 7.2 16.7-16.8" />
  </svg>
);
        ...
        <div className="pricing-container">
          ...
          <div className="pricing-cards">
            <div className="pricing-card">
              ...
              <button className="cta-button">Get Starter Pack</button>
            </div>
          </div>
        </div>
      </div>
