      ...
      <div className="container basic-grid-container">
        ...
        <div className="pricing-container">
          <div className="pricing-btn-container">
            <button
              className={`plan-toggle ${activePlan === "monthly" ? "active" : ""}`}
              onClick={() => handlePlanClick("monthly")}
            >
              Monthly
            </button>
            <button
              className={`plan-toggle ${activePlan === "annually" ? "active" : ""}`}
          ...
          <div className="pricing-cards">
            {plans.map((plan, index) => (
              <div className={`pricing-card ${plan.name === "Pro" ? "pro-border" : ""}`} key={index}>
                ...
                <div className="payment-type">{activePlan === "annually" ? "Annual payment" : "One-time payment"}</div>
